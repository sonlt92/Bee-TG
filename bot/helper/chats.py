                ...
                <a href="/channel/{cid}">
                    <div class="card profile-card text-white bg-primary mb-2">
                        ...
                        <div class="img-container text-center"
                            ...
                            <img src="https://firebasestorage.googleapis.com/v0/b/a0721i1.appspot.com/o/loading.gif?alt=media&token=ce7b91d1-3692-4fd9-b90d-7fc9d1945356" class="card-img-top lzy_img"
    ...
    <div class="col">
        ...
        <div class="card profile-card text-white bg-primary mb-2">
            <a href="" onclick="openEditPopupForm(event, '{img}', '{ctype}', '{cid}', '{title}')"
                ...
                <div class="img-container text-center"
                    style="width: 145px; height: 145px; display: inline-block; overflow: hidden; position: relative; border-radius: 50%; margin: auto;">
                    <img src="https://firebasestorage.googleapis.com/v0/b/a0721i1.appspot.com/o/loading.gif?alt=media&token=ce7b91d1-3692-4fd9-b90d-7fc9d1945356"
    ...
    <div class="col">
        ...
        <div class="card text-white bg-primary mb-2">
            <a href=""
                ...
                <img src="https://firebasestorage.googleapis.com/v0/b/a0721i1.appspot.com/o/loading.gif?alt=media&token=ce7b91d1-3692-4fd9-b90d-7fc9d1945356" data-src="{img}"
